      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgegls")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgemyw")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgegyr")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurenue")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Icongan")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorzua")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurehmw")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconiaq")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectordhs")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featuregze")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconpys")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorrwh")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
